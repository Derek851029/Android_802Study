...
public class DrawHook extends View {
    //绘制圆弧的进度值
    ...
    public DrawHook(Context context) {
        super(context);
    }

    public DrawHook(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DrawHook(Context context, AttributeSet attrs, int defStyle) {
